...
<div class="app-journal-list">
  ...
  <div class="bordered">
    <div class="editorial">
      ...
      Insights emerge from work presented through candid, first-person vantage points, staying with the in-between: art and research, practice and theory, making and writing. 
    </div>
  </div>
